...
<body>
	...
	/*connect database*/
		...
		require("connect.php");
		/*tao sql truy van*/
		$sql="select * from project_detail where id = $key";
	...
	<?php
		if(isset($_POST["btnsubmit"])){
			...
			require("connect.php");
			$sql = "CALL update_project_detail( '$project_id', '$content_html','$views','$is_disabled', '$key')";
			...
			<div>
				...
				<table border="1px">
					...
					<!-- show data project từ db -->
						...
						<td>
							<div class="form-group">
	                            <textarea class="form-control-textarea" name="content_html_project_detail" required><?php echo urldecode(trim($row['content_html'])); ?></textarea>
	                            <label class="label-control" for="cmessage"></label>
	                            <div class="help-block with-errors"></div>
	                        </div> 
						</td>

...
<body>
	...
	/*connect database*/
		...
		require("connect.php");
		/*tao sql truy van*/
		$sql="select * from contribution where id = $key";
 	...
 	<?php
		if(isset($_POST["btnsubmit"])){
			...
			require("connect.php");
			$sql = "CALL update_contribution( '$name', '$email', '$content', '$is_disabled', '$key') ";
			...
			<div>
				...
				<table border="1px">
					...
					<!-- show data contribute từ db -->
						...
						<td>
							<div class="form-group">
	                            <textarea class="form-control-textarea" name="email_contribute" required><?php echo urldecode(trim($row['email'])); ?></textarea>
	                            <label class="label-control" for="cmessage"></label>
	                            <div class="help-block with-errors"></div>
	                        </div> 
						</td>

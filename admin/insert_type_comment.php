...
<html>
<head>
	<title>Insert type Comment</title>
	<style type="text/css">
		*{
			text-align: center;
			margin: 0px;
...
<body>
 	...
 	<?php
		if(isset($_POST["btnsubmit"])){
			...
			require("connect.php");
			$sql = "CALL insert_type_comment( '$desc','$is_disabled')";
					...
					<!-- show data type comment từ db -->
						...
						<td>
							<div class="form-group">
	                            <textarea class="form-control-textarea" name="id_type_comment" disabled></textarea>

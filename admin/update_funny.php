...
<body>	
	...
	/*connect database*/
		...
		require("connect.php");
		/*tao sql truy van*/
		$sql="select * from funny where id = $key";
 	...
 	<?php
		if(isset($_POST["btnsubmit"])){
			...
			require("connect.php");
			$sql = "CALL update_funny( '$title', '$short_desc','$thumbnail','$link','$is_disabled', '$key')";
			...
			<div>
				...
				<table border="1px">
					...
					<tr>
						...
						<td>
							<div class="form-group">
	                            <textarea class="form-control-textarea" name="short_desc_funny" required><?php echo urldecode(trim($row['short_desc'])); ?></textarea>
	                            <label class="label-control" for="cmessage"></label>
	                            <div class="help-block with-errors"></div>
	                        </div> 
						</td>

...
<body>
 	...
 	<?php
		...
		if(isset($_POST["btnsubmit"])){
			...
			$sql = "CALL insert_hottrend( '$title', '$short_desc', '$thumbnail_hottrend','$link','$is_disabled')";
					...
					<!-- show data hottrend từ db -->
						...
						<td>
							<div class="form-group">
	                            <textarea class="form-control-textarea" name="id_hottrend" disabled></textarea>
						...
						<td>
							...
							<td>
							<div class="form-group">
	                            <textarea class="form-control-textarea" name="short_desc_hottrend" required></textarea>
	                            <label class="label-control" for="cmessage"></label>
	                            <div class="help-block with-errors"></div>
	                        </div> 
						</td>

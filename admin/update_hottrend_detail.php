...
<html>
<head>
	<title>Update Hot Trend Detail Gr3atCode</title>
	<style type="text/css">
		*{
			text-align: center;
			margin: 0px;
...
<body>
	...
	/*connect database*/
		...
		require("connect.php");
		/*tao sql truy van*/
		$sql="select * from hottrend_detail where id = $key";
 	...
 	?>
		...
		if(isset($_POST["btnsubmit"])){
			...
			require("connect.php");
			$sql = "CALL update_hottrend_detail('$id_hottrend','$content_html', '$views', '$is_disabled', '$key')";
				...
				<table border="1px">
					...
					<!-- show data hottrend detail từ db -->
						...
						<td>
							...
							<td>
							<div class="form-group">
	                            <textarea class="form-control-textarea" name="content_html_hottrend_detail" required><?php echo urldecode(trim($row['content_html'])); ?></textarea>
	                            <label class="label-control" for="cmessage"></label>
	                            <div class="help-block with-errors"></div>
	                        </div> 
						</td>
